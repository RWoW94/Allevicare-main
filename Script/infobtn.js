    ...
    document.querySelector(".info_button").addEventListener("click", function () {
        ...
        <div class="boxspan_1-5_row card">
            <div class="card_mg_inline card_mg_block">
                ...
                <div class="card_flex">
                    <div class="info_button1">Smarta lås & kameraövervakning</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Sensorer & larm</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Ljus & belysning</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Trygghetsknappar & larmtjänster </div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Installationsguider IKEA</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Röststyrning</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Styrning via mobilen</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Iphone guide</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Laddar ner & använd appar</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Swish</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Hur funkar pensionen?</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Extra inkomst som pensionär</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Bostadstillägg</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Framtidsfullmakt</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Testamente & arv</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Bouppteckning</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Träningstips</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Minska fallrisk</div>
                ...
                <div class="card_flex">
                    <div class="info_button1">Senioraktiviteter</div>
                 ...
                 <div class="card_flex">
                    <div class="info_button1">Volontärarbete</div>
