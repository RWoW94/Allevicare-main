document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".setting__button").addEventListener("click", function () {
      ...
      const settingCard = `<div class="boxspan_full card card_flex">
      <div class="card_mg_inline card_mg_block" style="width: 100%;"> 
        ...
        <div class="card_flex card_flex_col">
          ...
          <button class="button1 btn_click" onclick="saveSettings()">Spara ändringar</button>
        </div>
      </div>
    </div>`;
      
      container.innerHTML = settingCard;
    });
  });
